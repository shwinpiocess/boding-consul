...
import (
	"github.com/shwinpiocess/bonding-consul/backend/allocator"
	"github.com/shwinpiocess/bonding-consul/backend/consul"
...
func cmdDel(args *skel.CmdArgs) error {
	...
	store, err := consul.New(ipamConf.Name, ipamConf.DataDir)
	if err != nil {
		return err
	}
	defer store.Close()
